[![Travis build status shield](https://img.shields.io/travis/hsubtil/poc-notification/master.svg)](https://travis-ci.org/hsubtil/poc-notification)
[![Github Release version shield](https://img.shields.io/github/tag/hsubtil/poc-notification.svg)](https://github.com/hsubtil/poc-notification/releases)
[![jest](https://facebook.github.io/jest/img/jest-badge.svg)](https://github.com/facebook/jest)


# poc-notification

## What's poc-notification?
...
Hacking the Cozy poc-notification app requires you to [setup a dev environment][setup].

You can then clone the app repository and install dependencies:

```sh
$ git clone https://github.com/hsubtil/poc-notification.git
$ cd poc-notification
$ yarn install
```
...
After the build and the docker image launched, your app is now available at http://poc-notification.cozy.tools:8080.
...
If you want to work on poc-notification and submit code modifications, feel free to open pull-requests! See the [contributing guide][contribute] for more information about how to properly open pull-requests.
...
The lead maintainer for poc-notification is [hsubtil](https://github.com/hsubtil), send him/her a :beers: to say hello!
...
poc-notification is developed by hsubtil and distributed under the [AGPL v3 license][agpl-3.0].
