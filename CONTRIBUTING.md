# How to contribute to poc-notification?
...
- What is the version of the poc-notification app?
...
```
$ git clone github.com/hsubtil/poc-notification.git
$ cd poc-notification
$ git remote add fork git://github.com/yourusername/poc-notification.git
```
...
Go to https://github.com/yourusername/poc-notification and select your branch. Click the 'Pull Request' button and fill out the form.
...
The poc-notification is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/hsubtil/poc-notification/issues/new
...
[localization]: https://github.com/hsubtil/poc-notification/blob/master/README.md#localization
